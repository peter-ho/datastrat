 ...
 */
case class AuditLog (load_log_key: String, rfrsh_nbr:String, subj_area_nm:String, src_tbl_nms: Array[String], tgt_tbl_nm: String, load_strt_dtm: java.sql.Timestamp, load_end_dtm: java.sql.Timestamp, trgt_cnt: Long, trgt_orig_cnt: Long, comment: String, load_type: String, status: String, load_by: String)
