...
DROP TABLE IF EXISTS playerlogonsummary;

CREATE EXTERNAL TABLE IF NOT EXISTS playerlogonsummary (
...
STORED AS PARQUET
LOCATION '/${hivevar:env}/${hivevar:org}/data/gaming/${hivevar:dvr}/${hivevar:db}/playerlogonsummary;
