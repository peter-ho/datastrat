...
DROP TABLE IF EXISTS activitylog_hst;

CREATE EXTERNAL TABLE IF NOT EXISTS activitylog_hst (
...
STORED AS PARQUET
LOCATION '/${hivevar:env}/${hivevar:org}/data/gaming/${hivevar:dvr}/stg/activitylog_hst';
